# alertlogic al-ruby23-el7 rpm for centos7/amzn2
...
git clone git@github.com:alertlogic/al-ruby23-el7.git ${MYREPO}
cd ${MYREPO}
```
2. search and replace al-ruby23-el7 with ${MYREPO}
```bash
# macos bsd sed: LC_ALL=C find . -not -path '*/\.*' -type f -name "*" -exec sed -i '' "s/al-ruby23-el7/${MYREPO}/g" {} +
# macos gnu sed: find . -not -path '*/\.*' -type f -name "*" -exec gsed -i "s/al-ruby23-el7/${MYREPO}/g" {} +
find . -type f -name "*" -exec sed -i "s/al-ruby23-el7/${MYREPO}/g" {} +
mv SPECS/al-ruby23-el7.spec SPECS/${MYREPO}.spec
mv SOURCES/al-ruby23-el7 SOURCES/${MYREPO}
mv SOURCES/${MYREPO}/etc/default/al-ruby23-el7 SOURCES/${MYREPO}/etc/default/${MYREPO}
mv SOURCES/${MYREPO}/usr/local/share/al-ruby23-el7 SOURCES/${MYREPO}/usr/local/share/${MYREPO}
mv SOURCES/${MYREPO}/usr/local/sbin/al-ruby23-el7-config.sh SOURCES/${MYREPO}/usr/local/sbin/${MYREPO}-config.sh
rm -rf .git
git init
git add .
...
sudo yum install al-ruby23-el7
```
...
BOOTSTRAP=true yum install -y al-ruby23-el7
